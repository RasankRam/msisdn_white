    ...
    <div style="width:1200px" class="uk-container">
      <div uk-navbar>
        <div class="uk-navbar-left">
          ...
          <u-btn class="reset_button" @click="reset" uk-tooltip="Перевести сайт в начальное состояние">Сбросить</u-btn>
<!--          <a @click="reset" class="reset_button" uk-tooltip="Перевести сайт в начальное состояние">Сбросить</a>-->
        </div>
